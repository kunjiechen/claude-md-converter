...
from .pdf_converter_reportlab import PDFConverterReportlab
...
class BatchProcessor:
    ...
    def __init__(self, **options):
        ...
        # 初始化转换器
        if self.format == 'word':
            self.converter = WordConverter(**options)
        else:
            self.converter = PDFConverterReportlab(**options)
